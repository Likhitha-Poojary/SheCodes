...
[void]$cit.AddScript("cd `"c:\Users\Megha Kulal\SheCodes\frontend\citizen`" ; npx next dev -p 3001")
...
[void]$off.AddScript("cd `"c:\Users\Megha Kulal\SheCodes\frontend\officer`" ; npx next dev -p 3002")
...
[void]$adm.AddScript("cd `"c:\Users\Megha Kulal\SheCodes\frontend\admin`" ; npx next dev -p 3003")
...
[void]$aid.AddScript("cd `"c:\Users\Megha Kulal\SheCodes\frontend\ai-dashboard`" ; npx next dev -p 3004")
