...
[void]$api.AddScript("cd c:\Users\likit\OneDrive\Desktop\SheCodes\backend ; python -m uvicorn app:app --host 0.0.0.0 --port 8080 --reload")
...
[void]$cit.AddScript("cd '$PSScriptRoot\frontend\citizen' ; npm run dev -- -p 3001")
...
[void]$off.AddScript("cd '$PSScriptRoot\frontend\officer' ; npm run dev -- -p 3002")
...
[void]$adm.AddScript("cd '$PSScriptRoot\frontend\admin' ; npm run dev -- -p 3003")
...
[void]$aid.AddScript("cd '$PSScriptRoot\frontend\ai-dashboard' ; npm run dev -- -p 3004")
